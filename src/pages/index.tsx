...
const Index: FC = () => {
  ...
  return (
    <main>
      <Typography.Title level={2}>Konoha</Typography.Title>
      <div>
        <ProForm
          formRef={formRef}
      ...
      <Alert
        message="Disclaimer"
        description="This is a techinical review to demonstrate the idea. The Application still needs a translation API integration to fullfill it's functionality."
        type="info"
        showIcon
      />
